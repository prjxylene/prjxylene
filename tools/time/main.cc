...
void print_banner() {
	...
	substrate::console.writeln("\nxy-time: Xilinx FPGA® timing utility\n"sv);

	substrate::console.writeln("xy-time is part of the Xylene project <https://github.com/prjxylene>"sv);
	substrate::console.writeln("xy-time is licensed under the BSD-3-Clause <https://spdx.org/licenses/BSD-3-Clause.html>"sv);
...
void print_version() {
	substrate::console.writeln("xy-time v"sv, xyc::version);
}
