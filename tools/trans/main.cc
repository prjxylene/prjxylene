...
void print_banner() {
	...
	substrate::console.writeln("\nxy-trans: Xilinx FPGA® Transceiver utility\n"sv);

	substrate::console.writeln("xy-trans is part of the Xylene project <https://github.com/prjxylene>"sv);
	substrate::console.writeln("xy-trans is licensed under the BSD-3-Clause <https://spdx.org/licenses/BSD-3-Clause.html>"sv);
...
void print_version() {
	substrate::console.writeln("xy-trans v"sv, xyc::version);
}
