...
void print_banner() {
	...
	substrate::console.writeln("\nxy-bit: Xilinx FPGA® bitstream utility\n"sv);

	substrate::console.writeln("xy-bit is part of the Xylene project <https://github.com/prjxylene/prjxylene>"sv);
	substrate::console.writeln("xy-bit is licensed under the BSD-3-Clause <https://spdx.org/licenses/BSD-3-Clause.html>"sv);
...
void print_version() {
	substrate::console.writeln("xy-bit v"sv, xyc::version);
}
