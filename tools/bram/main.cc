...
void print_banner() {
	substrate::console.writeln(
		...
		substrate::console.writeln("\nxy-bram: Xilinx FPGA® block-ram utility\n"sv);

	substrate::console.writeln("xy-bram is part of the Xylene project <https://github.com/prjxylene>"sv);
	substrate::console.writeln("xy-bram is licensed under the BSD-3-Clause <https://spdx.org/licenses/BSD-3-Clause.html>"sv);
...
void print_version() {
	substrate::console.writeln("xy-bram v"sv, xyc::version);
}
